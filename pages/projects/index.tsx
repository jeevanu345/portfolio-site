...
const ColorPaletteSelector = dynamic(
  () => import('../../components/ColorPaletteSelector'),
  { ssr: false }
);
    ...
    <div className="my-4 sm:my-10">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          A collection of projects showcasing my journey across full-stack
          development, AI/ML, distributed systems, and IoT.
        </p>
      </div>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  <SelectItem value="priority">Jeevan's Favorites</SelectItem>
                </SelectGroup>
              </SelectContent>
            </Select>
          </div>
