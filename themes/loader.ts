...
const THEME_REGISTRY = {
  ...
  sunset: () => import('./data/sunset').then(m => m.sunsetTheme),
  midnight: () => import('./data/midnight').then(m => m.midnightTheme),
  emerald: () => import('./data/emerald').then(m => m.emeraldTheme),
  lavender: () => import('./data/lavender').then(m => m.lavenderTheme),
} as const;
